            ...
            <div class="cover">
              ...
              <div class="cover-body d-flex justify-content-between align-items-center">
                ...
                <div class="d-none d-md-block">
                  <RouterLink :to="{ name: 'profile_edit'}" class="btn btn-primary btn-icon-text btn-edit-profile">
        ...
        <div class="d-none d-md-block col-md-4 col-xl-3 left-wrapper">
          <div class="card rounded">
            <div class="card-body">
              ...
              <p>Hi! I'm Amiah the Senior UI Designer at Vibrant. We hope you enjoy the design and quality of Social.
              </p>
              <div class="mt-3">
                ...
                <div class="card-body" v-for="info in users" :key="info.id">
                  ...
                  <div class="d-flex justify-content-between mb-2 pb-2 border-bottom">
                    ...
                    <button class="btn btn-icon">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        class="feather feather-user-plus" data-toggle="tooltip" title="" data-original-title="Connect">
