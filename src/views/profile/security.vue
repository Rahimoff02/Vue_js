...
<template>
    <div class="container-xl px-4 mt-4">
        ...
        <nav class="nav nav-borders">
            <RouterLink :to="{ name: 'profile_index'}" class="nav-link">Profile</RouterLink>

            <RouterLink :to="{ name: 'profile_edit'}" class="nav-link">Edit</RouterLink>

            <RouterLink :to="{ name: 'profile_security'}" class="nav-link active ms-0">Security</RouterLink>
        </nav>
        <hr class="mt-0 mb-4">
        <div class="row">
            <div class="col-lg-8">
